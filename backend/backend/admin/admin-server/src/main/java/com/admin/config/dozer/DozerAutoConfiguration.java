package com.admin.config.dozer;
...
@EnableConfigurationProperties(com.admin.config.dozer.DozerConfigurationProperties.class)
public class DozerAutoConfiguration {

    private final com.admin.config.dozer.DozerConfigurationProperties configurationProperties;
     ...
     */
    @Autowired
    public DozerAutoConfiguration(com.admin.config.dozer.DozerConfigurationProperties configurationProperties) {
