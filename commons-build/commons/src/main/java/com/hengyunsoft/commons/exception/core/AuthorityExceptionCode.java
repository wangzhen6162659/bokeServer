...
public enum  AuthorityExceptionCode implements BaseExceptionCode {
    ...
    ROLE_NAME_NULL(52004,"角色名[name]不能为空"),
    ROLE_RESOURCE_ID_NULL(52005,"关联资源[resourceIdList]不能为空"),
    ROLE_USER_ID_NULL(52006,"关联用户ID[userIdList]不能为空"),
    ROLE_APP_ID_NULL(52007,"角色应用ID[appId]不能为空"),
    ROLE_READONLY(52008,"角色为只读，不可以编辑"),
    DEPART_USER_NOT_EXIST(53509, "该角色对应的用户找不到"),
    ROLE_NAME_EXIST(52010,"角色名[name]已经存在"),
